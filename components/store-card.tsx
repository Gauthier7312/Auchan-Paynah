...
export default function StoreCard() {
    return (
        <div className="group min-w-[250px] h-[200px] bg-white rounded-[40px] p-[26px] flex flex-col justify-between gap-4 transition-[background] duration-300 hover:bg-[radial-gradient(104.5%_149.38%_at_-2.6%_-7.25%,#FFBDC4_0%,#E0001A_49.04%)] cursor-pointer">
