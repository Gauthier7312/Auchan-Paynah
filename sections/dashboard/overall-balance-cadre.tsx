...
export default function OverallBalanceCadre() {
    ...
    return (
    <div className="bg-primary rounded-[40px] w-full min-h-[280px] sm:min-h-[300px] lg:h-[330px] relative overflow-hidden">
            <div className="absolute top-0 right-[25px] sm:right-[14px] w-[442px] h-[357px]">
            ...
            <div className="text-white h-full p-8 flex flex-col justify-between relative z-10">
                <div className="flex flex-col gap-2.5 sm:gap-3.5">
                    <p className="text-xl sm:text-[26px] font-sana-sans-bold">Solde globale</p>
